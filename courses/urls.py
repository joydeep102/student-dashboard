...
urlpatterns = [
    ...
    path("course/<slug:slug>/learn/<int:pk>/question/add/", course_views.add_question, name="add_question"),
    path("course/<slug:slug>/question/<int:qpk>/reply/add/", course_views.add_reply, name="add_reply"),
